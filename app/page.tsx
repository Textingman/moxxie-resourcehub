    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FFFFFF' }}>
      ...
      <section className="py-20" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold" style={{ color: '#1F2937' }}>Why Choose Very Resourceful</h2>
            <p className="mt-4 text-xl" style={{ color: '#6B7280' }}>Helping families find the right resources in moments that matter most.</p>
          </div>
      ...
      <section className="py-20" style={{ backgroundColor: '#EFF6FF' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-10" style={{ color: '#6B7280' }}>Join thousands of people who trust Very Resourceful.</p>
